...
# Define the GPIO interrupt callback
def gpio_callback(channel):
    """Callback function triggered by GPIO interrupt."""
    print("GPIO Trigger Received!")
    board_shim.config_board(MindroveConfigMode.BEEP)


# Set up GPIO interrupt
GPIO.add_event_detect(TRIGGER_PIN, GPIO.RISING, callback=gpio_callback, bouncetime=200)  # Adjust bouncetime as needed
